<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Istatistikler.aspx.cs" Inherits="CRM1.İstatistikler" %>
            ...
            <li>
                <a href="#">
                    ...
                    <div class="ca-content">
                        ...
                        <h3 class="ca-sub two">Sipariş Tutarı</h3>
                    </div>
                </a>
            </li>
            <li>
                <a href="#">
                    ...
                    <div class="ca-content">
                        ...
                        <h3 class="ca-sub three">Kullanıcı Sayımız</h3>
                    </div>
                </a>
            </li>
            <li>
